...
class TemperaturesControllerTest < ActionController::TestCase
  ...
  test "should create temperature" do
    assert_difference('Temperature.count') do
      post :create, temperature: { avg: @temperature.avg, date: @temperature.date, max: @temperature.max, min: @temperature.min, station_id: @temperature.station_id }
    end
  ...
  test "should update temperature" do
    patch :update, id: @temperature, temperature: { avg: @temperature.avg, date: @temperature.date, max: @temperature.max, min: @temperature.min, station_id: @temperature.station_id }
    assert_redirected_to temperature_path(assigns(:temperature))
  end
